...
class NewMiscellaneousPage extends React.Component {
...
NewMiscellaneousPage.propTypes = {
  countries: PropTypes.array
};

NewMiscellaneousPage.defaultProps = {
  countries: []
};
...
export default connect(mapStateToProps, null)(NewMiscellaneousPage);
